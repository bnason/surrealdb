...
impl Iterator {
	...
	pub async fn output(
		...
		println!("Setting Up Orders: {:?}", self.orders);
		...
		if plan.do_iterate {
			...
			println!("Processing Orders: {:?}", self.orders);
